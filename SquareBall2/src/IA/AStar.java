...
import squareball2.Jogo;
import squareball2.Wall;
import squareball2.Square;

//https://github.com/marcelo-s/A-Star-Java-Implementation/tree/master/src/com/ai/astar
...
public class AStar {
    ...
    private void setNodes() {
        ...
        /*for (int i = 0; i < this.jogo.level1.length; i++) {
            for (int j = 0; j < this.jogo.level1[0].length; j++){
               if (this.jogo.level1[i][j] == 0){
                    Node node = new Node(i, j);
                    node.calculateHeuristic(getFinalNode());
                    this.searchArea[i][j] = node;
               } 
